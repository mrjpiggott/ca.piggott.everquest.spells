...
public class SpellParser {
	...
	private final Map<Long, Spell> parsedSpells = new LinkedHashMap<Long, Spell>();

	private final Map<DbStrKey, String> dbstr = new HashMap<DbStrKey, String>();

	private final Map<Integer, Spell> set = new HashMap<Integer, Spell>();
